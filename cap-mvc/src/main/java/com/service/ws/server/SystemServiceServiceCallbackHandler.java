/**
 * SystemServiceServiceCallbackHandler.java
 *
...
/**
 * SystemServiceServiceCallbackHandler Callback class, Users can extend this class and implement
 * their own receiveResult and receiveError methods.
 */
public abstract class SystemServiceServiceCallbackHandler {
   ...
   */
  public SystemServiceServiceCallbackHandler(Object clientData) {
    this.clientData = clientData;
  }

  /** Please use this constructor if you don't want to set any clientData */
  public SystemServiceServiceCallbackHandler() {
  ...
  /**
   * auto generated Axis2 call back method for execute method override this method for handling
   * normal response from execute operation
   */
  public void receiveResultexecute(
      com.service.ws.server.SystemServiceServiceStub.ExecuteResponseE result) {}
