...
/**
 * For Websphere use SSL utils
 * @author TimChiang
 * @version
 *          <ul>
 *          <li>2021/04/14,TimChiang,new
 *          </ul>
 * @since 2021/04/14
 */
public class IisiSSLUtils {

    private final static Logger logger = LoggerFactory.getLogger(IisiSSLUtils.class);
