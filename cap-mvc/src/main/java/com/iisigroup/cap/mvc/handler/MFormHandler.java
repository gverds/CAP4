                        ...
                        if (checkFlow != null && !StringUtils.isEmpty(checkFlow.name())) {
                            ...
                            if (flowMethod != null) {
                                ...
                                if (flowmstr != null) {
                                    ...
                                    if (!"readMode".equals(params.get("idForWorkEmpChk")) && !Objects.equals(flowmstr.get("workEmp"), params.get("idForWorkEmpChk"))) {
                                        ...
                                        Object proxys = proxyMeth.invoke(proxyDao,
                                                new String[] { (String) flowmstr.get("workEmp"), params.get("idForWorkEmpChk"), CapDate.getCurrentDate("yyyy/MM/dd") });
