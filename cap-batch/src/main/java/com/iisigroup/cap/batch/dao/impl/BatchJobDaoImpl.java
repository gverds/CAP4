...
public class BatchJobDaoImpl extends GenericDaoImpl<BatchJob> implements BatchJobDao {
    ...
    public List<BatchJob> listAll() {
        return getNamedJdbcTemplate().query("batchJob.findPage", null, MapUtils.EMPTY_MAP, new BatchJobRowMapper());
    }
    ...
    public void update(BatchJob job) {
        Map<String, Object> args = CapBeanUtil.bean2Map(job, CapBeanUtil.getFieldName(BatchJob.class, true));
